...
const os = __importStar(__nccwpck_require__(37));
const uuid_1 = __nccwpck_require__(270);
const utils_1 = __nccwpck_require__(278);
...
const auth_1 = __nccwpck_require__(228);
...
const undici_1 = __nccwpck_require__(618);
...
const from_branch_1 = __nccwpck_require__(38);
const has_author_in_1 = __nccwpck_require__(571);
...
const validateApprovals = ({ rule, reviews, payload, }) => {
    ...
    for (const review of reviews) {
        ...
        if (!latestReviewByUser.has(reviewer) ||
